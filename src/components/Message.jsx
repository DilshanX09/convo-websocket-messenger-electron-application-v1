                                                  ...
                                                  {hasImage && !msg.MESSAGE && (
                                                       ...
                                                       <div className={`${isSender ? 'bg-[#075e54]' : 'bg-[#202c33]'} p-[2px] rounded-md relative`}>
                                                            ...
                                                            <img
                                                                 ...
                                                                 className="cursor-pointer max-w-[400px] max-h-[300px] rounded-md shadow"
                                                            />
                                                            <span
                                                                 className="absolute  bottom-[1px] right-2 pl-[10px] text-[10px] text-gray-300 SF-pro-regular pr-[1px] pb-[2px] flex items-center gap-1"
                                                            >
                                                                 ...
                                                                 {isSender && (
                                                                      <>
                                                                           {msg.STATUS === "sent" && (
                                                                                <MdDone className="text-gray-800 ml-[2px] text-[17px]" />
                                                                           )}
                                                                           {msg.STATUS === "delivered" && (
                                                                                <MdDoneAll className="text-gray-800 ml-[2px] text-[17px]" />
                                                                           )}
                                                                           {msg.STATUS === "read" && (
                                                                                <MdDoneAll className="text-blue-400 ml-[2px] text-[17px]" />
                                                                           )}
                                                                           {msg.STATUS === null && (
                                                            ...
                                                            <div className={`relative rounded-md ${msg.MESSAGE && 'px-1 py-1'} max-w-full ${isSender ? "bg-[#075e54] text-white" : "bg-[#202c33] text-white"}`}>
                                                                 ...
                                                                 {msg.MESSAGE &&
                                                                      ...
                                                                      <div className="relative">
                                                                           ...
                                                                           <p
                                                                                className={`break-words px-2 py-1 pr-[80px] ${msg.MESSAGE === "You deleted this message." || msg.MESSAGE === "Deleted this message."
                                                                                     ? "SF-pro-regular text-gray-400 text-[14px]"
                                                                                     : isSingleEmoji(msg.MESSAGE)
                                                                                          ? "text-[35px]"
                                                                                          : "text-[16px] SF-pro-regular"
                                                                                     }`}
                                                                           >
                                                                           ...
                                                                           <span
                                                                                className={`absolute bottom-[-2px] right-0 pl-[20px] text-[11px] text-gray-400 SF-pro-regular pr-[1px] pb-[2px] flex items-center gap-1`}
                                                                           >
                                                                                {formatDate(msg.DATE)}
